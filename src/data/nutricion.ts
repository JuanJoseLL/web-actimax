...
export const FORMULAS: Record<string, FormulaNutricional> = {
  pre: {
    ...
    preparacion: "36 g en 250 ml de tu bebida preferida.",
  ...
  energy: {
    ...
    preparacion: null, uso: "1 tubo cada 30 min en competencia o cada 45 min en entrenamiento; 1–2 por hora según necesidades en esfuerzos de más de una hora.",
  ...
  gel30: {
    ...
    preparacion: null, uso: "1 sobre cada 30 min en competencia o cada 45 min en entrenamiento; 1–2 por hora en esfuerzos de más de una hora.",
    momentos: ["durante"], ingredientesDeclarados: [], atributos: atributosDesconocidos,
  ...
  gel90: {
    ...
    preparacion: null, uso: "Medio sobre cada 30 min en competencia o cada 45 min en entrenamiento. Opción para esfuerzos de más de 2 horas.",
    momentos: ["durante"], ingredientesDeclarados: [], atributos: atributosDesconocidos,
  ...
  eliteCon: {
    ...
    uso: "500 ml por hora, en sorbos cada 10–15 min.",
    momentos: ["durante"], ingredientesDeclarados: [], atributos: atributosDesconocidos,
    notas: ["500 ml por hora es una guía de producto, no una medición de sudoración personal.", "La tabla usa 15 g/240 ml; los destacados usan 30 g/500 ml. Los cálculos usan exclusivamente los destacados por bidón.", "55 mg de cafeína por bidón completo, no por media porción.", "Sellos del tarro: exceso en sodio, exceso en azúcares, contiene edulcorantes."],
  ...
  recoveryPro: {
    ...
    preparacion: "37 g en 250 ml de agua.", uso: "En los primeros 30 minutos después de entrenamientos o competencias intensas.",
  ...
  recovery: {
    ...
    preparacion: "35 g en 250 ml de agua.",
    ...
    atributos: { vegano: false, sinLacteos: false, sinGluten: null },
    notas: ["Tabla por 240 ml y preparación por 250 ml: conservar valores por 35 g.", "Las medidas volumétricas del catálogo son inconsistentes (la ficha menciona 2½ cucharadas y la preparación 2 medidas); usar gramos."],
